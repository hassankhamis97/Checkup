    ...
    override func viewDidLoad() {
        ...
        tsetsNames=[tableGuid(letters: "A", names: ["ACTH (Adreno Corticotropic Hormone)",
                                                    "Adenosine Deaminase" ,"AFP (Alpha Feto Protein)"," Alberts Stain","Albumin ","Ammonia"]),tableGuid(letters: "B", names: ["Bleeding / Clotting Time)",
                                                                                                                                                                              "Blood Culture","Blood Urea Nitrogen","Beta HCG"," Bilirubin Test"]),tableGuid(letters: "C", names: ["C-Peptide ","CA 15.3 ","CA 27.29 ","CBC ","Chlamydia"," COVID 19","Cytomegalovirus (CMV)"]),tableGuid(letters: "D", names: ["Dimer","Dengue IgG","DNA","Dengue NS1 Test"
