...
//    let params : [ "id" : reqId ]
           ...
           let urlString = "http://checkup.somee.com/api/AnalysisService/DeleteClientAnalysisRequest"
           // , parameters: params 
           Alamofire.request(urlString, method: .post , encoding: JSONEncoding.default, headers: nil).responseJSON {
                             response in
